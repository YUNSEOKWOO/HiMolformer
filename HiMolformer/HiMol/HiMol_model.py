...
class GINConv(MessagePassing):
    ...
    def __init__(self, emb_dim, aggr = "add"):
        ...
        self.edge_embedding1 = torch.nn.Embedding(num_bond_type, emb_dim).to(device)
        self.edge_embedding2 = torch.nn.Embedding(num_bond_direction, emb_dim).to(device)
...
class GNN(torch.nn.Module):
    ...
    def __init__(self, num_layer, emb_dim, JK = "last", drop_ratio = 0, gnn_type = "gin"):
        ...
        self.x_embedding1 = torch.nn.Embedding(num_atom_type, emb_dim).to(device)
        self.x_embedding2 = torch.nn.Embedding(num_chirality_tag, emb_dim).to(device)
